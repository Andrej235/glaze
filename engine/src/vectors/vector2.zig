...
pub const Vector2 = struct {
    ...
    pub inline fn fromScalar(scalar: f32) Vector2 {
    ...
    pub inline fn fromVec3(vector3: *Vector3) Vector2 {
        return fromXY(vector3.x, vector3.y);
    }

    pub inline fn fromVec4(vector4: *Vector4) Vector2 {
        return fromXY(vector4.x, vector4.y);
    }

    pub inline fn toVec3(self: *Vector2) Vector3 {
        return Vector3.fromVec2(self);
    }

    pub inline fn toVec3WithZ(self: *Vector2, z: f32) Vector3 {
        return Vector3.fromVec2WithZ(self, z);
    }

    pub inline fn toVec4(self: *Vector2) Vector4 {
        return Vector4.fromVec2(self);
    }

    pub inline fn toVec4WithZW(self: *Vector2, z: f32, w: f32) Vector4 {
        return Vector4.fromVec2WithZW(self, z, w);
    }

    pub inline fn toArray(self: *Vector2) [2]f32 {
